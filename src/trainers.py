...
class Trainer:
    ...
    def neg_sample(self, batch_items):
        # if self.args.neg_generate=="random":
        #     item = random.randint(1, item_size - 1)
        #     while item in item_set:
        #         item = random.randint(1, item_size - 1)
        #     return item
        if self.args.neg_generate=="batch":
    ...
    def iteration(self, epoch, dataloader, train=True):
        ...
        if train:
            ...
            for i, batch in rec_data_iter:
                ...
                user_ids, input_ids, answers, neg_answer, same_target = batch # input_ids 256 50 前向补0
            ...
            for i, batch in rec_data_iter:
                ...
                recommend_output,_ = self.model.predict(input_ids, user_ids)
