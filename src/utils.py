...
def parse_args():
    ...
    parser.add_argument("--load_model", default='freqrec_Beauty', type=str)
    parser.add_argument("--train_name", default="freqrec_Beauty", type=str)
    parser.add_argument("--num_items", default=10, type=int)
    parser.add_argument("--num_users", default=10, type=int)

    # train args
    parser.add_argument("--lr", default=0.0005, type=float, help="learning rate of adam")
    ...
    # model args
    parser.add_argument("--model_type", default='freqrec', type=str)
    ...
    elif args.model_type.lower() == 'freqrec':
        parser.add_argument("--alpha", default=0.7, type=float)
        parser.add_argument("--gama", type=float,default=0.7,help="")
        parser.add_argument("--fourier_loss", default=True)
        parser.add_argument("--fft_loss_type", default="l1")
        parser.add_argument("--alpha_loss", default=0.6, type=float)
        parser.add_argument("--chux", type=str, default="p", help="p，c")
